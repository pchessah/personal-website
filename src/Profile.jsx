            ...
            <div className="w3-container w3-card w3-white w3-margin-bottom">
              ...
              <div className="w3-container">
                ...
                <p>
                  ...
                  React, Mongo dB Node and Express for various projects
                  including a delivery application and a budget application.
                  Experience in SDLC through development of capstone project of
                  a delivery application highlighting skills in Requirements
                  analysis, implementation and maintenance. Deployment of
                  various projects on Heroku and updated changes on the Heroku
                  platform when application required changes. Develop user
                  interfaces using React, HTML5 and CSS3 for delivery
                  application. Code review of various projects implementing
                  skills and knowledge in best practices in software development
                  and refactoring code to improve output as well as debugging
                  common errors in software. Good experience in understanding
                  One-way data flow, virtual DOM, JSX, components, state and
                  composition based on fundamentals in React and using it on
                  delivery and budget application in development. Worked with
                  components, Forms, Routers and Events using React .Develop
                  unit tests for applications and software during learning and
                  code review sessions. using Jest and enzyme. Maintaining state
                  and stores and dispatched actions using redux while creating
                  reducers to be used to modify state tree on a budget app
                  .Extensively use git for version control and pushing code to
                  GitHub for the projects.
                </p>
                <hr />
              </div>
              <div className="w3-container">
                ...
                <p>
                  ...
                  domain network . Attending to a wide variety of help desk
                  tasks assigned from time to time by the help desk team leader
              ...
              <div className="w3-container">
                ...
                <p>
                  ...
                  Elevated systems security with installation of antivirus for
                  end users and update of security software (Kaspersky and
                  McAfee antivirus and Windows defender). Steered Network design
                  and configuration, system back-ups and cabling design and
            ...
            <div className="w3-container w3-card w3-white">
              ...
              <div className="w3-container">
                ...
                <p>
                  ...
                  implications for the practice of science, engineering, art,
              ...
              <div className="w3-container">
                ...
                <p>
                  ...
                  including implementation and verification of connections to
                  remote sites in a WAN. CCNA curriculum includes basic
                  mitigation of security threats, introduction to wireless
                  networking concepts and terminology, and performance-based
                  skills. This new curriculum also includes (but is not limited
                  to) the use of these protocols: IP, Enhanced Interior Gateway
                  Routing Protocol (EIGRP), Serial Line Interface Protocol Frame
                  Relay, Routing Information Protocol Version 2 (RIPv2),VLANs,
